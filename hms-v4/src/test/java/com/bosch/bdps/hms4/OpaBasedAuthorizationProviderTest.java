...
public class OpaBasedAuthorizationProviderTest {
    ...
    @Test
    public void testAuthorizeUserLevel() throws Exception {
        ...
        authorizationProvider.authorizeDbLevelOperations(readPriv, writePriv, null, null);
    ...
    @Test
    public void testAuthorizeDatabase() throws Exception {
    ...
    @Test
    public void testAuthorizeTable() throws Exception {
    ...
    @Test
    public void testAuthorizePartition() throws Exception {
    ...
    @Test
    public void testAuthorizeColumns() throws Exception {
        Table table = mock(Table.class);
        Partition partition = mock(Partition.class);
