...
public class OpaOfficialHmsDockerIT {
    ...
    String[] serviceOptsArr = new String[] {
            ...
            "-Dhive.log.level=TRACE",
            "-Dhive.metastore.pre.event.listeners=com.bosch.bdps.hms4.OpaAuthorizationPreEventListener",
            "-Dhive.security.metastore.authorization.manager=com.bosch.bdps.hms4.OpaBasedAuthorizationProvider",
